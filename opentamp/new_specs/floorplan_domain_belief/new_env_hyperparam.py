...
from opentamp.policy_hooks.custom_agents.rnn_gym_floorplan_agent import RnnGymFloorplanAgent
...
def refresh_config(no=NUM_OBJS, nt=NUM_TARGS):
    ...
    config = {
        ...
        'meta_file': opentamp.__path__._path[0] + '/new_specs/floorplan_domain_belief/floorplan_meta.json',
        'acts_file': opentamp.__path__._path[0] + '/new_specs/floorplan_domain_belief/floorplan_acts.json',
        'prob_file': opentamp.__path__._path[0] + '/new_specs/floorplan_domain_belief/floorplan_prob.json',
