...
from opentamp.policy_hooks.rnn_gym_floorplan_agent import RnnGymFloorplanAgent
import opentamp.new_specs.floorplan_domain.gym_prob as prob
...
def refresh_config(no=NUM_OBJS, nt=NUM_TARGS):
    ...
    config = {
        ...
        'meta_file': opentamp.__path__._path[0] + '/new_specs/floorplan_domain/floorplan_meta.json',
        'acts_file': opentamp.__path__._path[0] + '/new_specs/floorplan_domain/floorplan_acts.json',
        'prob_file': opentamp.__path__._path[0] + '/new_specs/floorplan_domain/floorplan_prob.json',
        'n_dirs': N_DIRS,
