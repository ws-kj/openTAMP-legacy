...
domain_file = opentamp.__path__._path[0] + "/domains/belief_space_domain/belief_grip.domain"
...
def prob_file(descr=None):
    ...
    return opentamp.__path__._path[0] + "/domains/belief_space_domain/probs/{0}.prob".format(descr)
